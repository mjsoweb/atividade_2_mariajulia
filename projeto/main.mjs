...
const pj1 = new PJ();
pj1.setNome("Maria Julia Santos");          // Método herdado de Pessoa
pj1.setEmail("maria@tech.com.br");    // Método herdado de Pessoa
pj1.setCNPJ("12.345.678/0001-99");      // Método próprio de PJ
pj1.setRazaoSocial("Tech 4 Solutions S.A."); // Método próprio de PJ

const pj2 = new PJ();
pj2.setNome("Gustavo Silva");
pj2.setEmail("gusta@logistica.com.br");
pj2.setCNPJ("98.765.432/0001-11");
pj2.setRazaoSocial("Mundo da Logística LTDA");
...
ieFabrica.setPJ(pj2); // Usando a segunda PJ
